...
Experiment 1/3:   Varying no. of hidden units
...
def plot_accuracy(trainingAccuracy, testingAccuracy, n):
    plt.figure(n)
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    ...
    plt.ylim(0, 100)
    plt.xlim(0, 50)
    plt.title('Experiment 1 - No. of hidden neurons (n): ' + str(n))
    lgd = plt.legend(loc=9, bbox_to_anchor=(0.5, -0.1),ncol=2)
    plt.savefig('accuracy_E1_n_'+str(n)+'.png',bbox_extra_artists=(lgd,), bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    # Perform experiment for no. of hidden neurons = 20, 50, 100
    for n in NUM_HIDDEN_NEURONS:
        print("")
        print("_________________________________________________________")
        print("No. of hidden neurons: " + str(n))
        print("_________________________________________________________")
        ...
        plot_accuracy(training_Accuracy_Array, test_Accuracy_Array, n)
